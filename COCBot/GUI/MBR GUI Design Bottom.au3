...
Global $g_hGrpVillage = 0, $g_hGrpVillageName = 0
...
Func CreateBottomPanel()
	...
	$g_hGrpVillageName = GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Bottom", "GrpVillageName", "VillageName"), $x - 5, $y - 10, 190, 108)
