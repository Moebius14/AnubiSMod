...
Func TabAdvancedGUI()
	...
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design - Advanced", "DropEverytime", "Drop trophies even when pause time or bad forecast."))
	...
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design - Advanced", "VisitBbaseEverytime", "Visit BBase If necessary even when pause time or bad forecast."))
	...
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design - Advanced", "CheckPersoChallengesEverytime", "Check Personnal Challenges even when pause time or bad forecast."))
