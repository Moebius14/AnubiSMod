...
Func CreateAttackSearchOptionsSearch()
	...
	GUICtrlSetData(-1, 2)         ; default value
	...
	$sTxtTip = GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkRestartSearchLimit_Info_01", "Return To Base after x-between searches and restart to search enemy villages.")
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetState(-1, $GUI_CHECKED)
	GUICtrlSetOnEvent(-1, "chkRestartSearchLimit")
	$g_hLblRestartSearchlimit = GUICtrlCreateLabel("From", $x + 5, $y + 17, 35, -1)
	$g_hTxtRestartSearchlimitMin = GUICtrlCreateInput("20", $x + 32, $y + 15, 25, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 2)
	GUICtrlSetOnEvent(-1, "TxtRestartSearchlimitMin")
	$g_hLblRestartSearchlimitAnd = GUICtrlCreateLabel("To", $x + 64, $y + 17, 20, -1)
	$g_hTxtRestartSearchlimitMax = GUICtrlCreateInput("50", $x + 82, $y + 15, 25, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 2)
	GUICtrlSetOnEvent(-1, "TxtRestartSearchlimitMax")
	$g_hLblRestartSearchlimitunit = GUICtrlCreateLabel("searches.", $x + 112, $y + 17, -1, -1)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 2)
	GUICtrlSetOnEvent(-1, "TxtRestartSearchlimitMinPause")
	$g_hLblRestartSearchlimitAndPause = GUICtrlCreateLabel("To", $x + 64, $y + 19, 20, -1)
	$g_hTxtRestartSearchlimitMaxPause = GUICtrlCreateInput("90", $x + 82, $y + 17, 25, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 2)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 2)
	GUICtrlSetOnEvent(-1, "SearchesPauseIntervalMax")
	$g_hSearchesPauseIntervalUnit = GUICtrlCreateLabel("minutes.", $x + 112, $y + 19, -1, -1)
