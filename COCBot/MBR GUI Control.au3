...
Func Bind_ImageList($nCtrl, ByRef $hImageList)
	...
	Switch $nCtrl
		Case $g_hTabMain
			...
			Local $aIconIndex = [$eIcnHourGlass, $eIcnTH15, $eIcnAttack, $eIcnGUIMod, $eIcnGUI, $eIcnInfo]
		...
		Case $g_hGUI_BOT_TAB
			...
			Local $aIconIndex = [$eIcnOptions, $eIcnAndroid, $eIcnDebugMod, $eIcnProfile, $eIcnGold]
