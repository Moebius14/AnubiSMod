...
Global $g_hFirstControlToHidemod = 0, $g_hLastControlToHidemod = 0
...
;~ ------------------------------------------------------
	...
	GUISetIcon($g_sLibModIconPath, $eIcnGUIMod)
	...
	; Create tray icon
	TraySetIcon($g_sLibModIconPath, $eIcnGUIMod)
	Opt("TrayMenuMode", 3)
