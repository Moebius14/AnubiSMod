...
;End Battle
Global $g_aGroupEndBattleDB = "", $groupEndBattkeAB = "", $groupKingSleeping = "", $groupQueenSleeping = "", $groupPrinceSleeping = "", $groupWardenSleeping = "", $groupCloseWhileTraining = "", $groupChampionSleeping = ""
