...
Global $aIsTrainPgChk1[4] = [803, 95 + $g_iMidOffsetY, 0xFF8D95, 10] ; Main Screen, Train page open - left upper corner of x button. Updated 15.352.22
...
Global $a12OrMoreSlots[4] = [24, 579 + $g_iBottomOffsetY, 0x86DEFC, 25] ; Attackbar Check if 12+ Slots exist
Global $a12OrMoreSlots2[4] = [24, 580 + $g_iBottomOffsetY, 0xFF4040, 25] ; Attackbar Check if 12+ Slots exist SuperTroops
Global $a12OrMoreSlots3[4] = [24, 580 + $g_iBottomOffsetY, 0xFFFDFF, 25] ; Attackbar Check if 12+ Slots exist Special Troops
Global $a12OrMoreSlots4[4] = [24, 580 + $g_iBottomOffsetY, 0xFFFFFF, 25] ; Attackbar Check if 12+ Slots exist Mash Troops
