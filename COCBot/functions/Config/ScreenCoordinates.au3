...
Global $aIsMain[4] = [378, 10, 0x7ABDE3, 15] ; Main Screen, Builder Info Icon / October 2023
...
Global $aIsTrainPgChk1[4] = [760, 120 + $g_iMidOffsetY, 0xFF8D95, 10] ; Main Screen, Train page open - left upper corner of x button. Updated 15.352.22
...
Global Const $aIsAttackPage2[4] = [50, 548 + $g_iBottomOffsetY, 0x5F0606, 20] ; red button "end battle" hidden by empty siege - left portion
