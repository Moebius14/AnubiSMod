...
Func applyConfig($bRedrawAtExit = True, $TypeReadSave = "Read") ;Applies the data from config to the controls in GUI
	...
	; <><><> CSV Deploy Speed <><><>
	ApplyConfig_MOD_600_57($TypeReadSave)
...
Func ApplyConfig_600_6($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			_GUICtrlComboBox_SetCurSel($g_hChkTreasuryCollect, $g_bChkTreasuryCollect)
			...
			GUICtrlSetState($g_hChkUseClockPotion, $bUseClockPotion = 1 ? $GUI_CHECKED : $GUI_UNCHECKED)
			...
			GUICtrlSetState($g_hChkEnableSmartSwitchCC, $g_bChkEnableSmartSwitchCC ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnablePurgeMedal, $g_bChkEnablePurgeMedal ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetData($g_acmdMedalsExpected, $g_iacmdMedalsExpected)
			GUICtrlSetState($g_hChkEnablePriorArmyCC, $g_bChkEnablePriorArmyCC ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnablePriorArmyCamp, $g_bChkEnablePriorArmyCamp ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnablePriorBarracks, $g_bChkEnablePriorBarracks ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnablePriorFactory, $g_bChkEnablePriorFactory ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnablePriorStorage, $g_bChkEnablePriorStorage ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnablePriorHallsCC, $g_bChkEnablePriorHallsCC ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnablePriorRuinsCC, $g_bChkEnablePriorRuinsCC ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnableOnlyRuinsCC, $g_bChkEnableOnlyRuinsCC ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkAutoUpgradeCCIgnore, $g_bChkAutoUpgradeCCIgnore ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkEnablePriorPrioritized, $g_bChkEnablePriorPrioritized ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkIsIgnoredWalls, $g_bChkIsIgnoredWalls ? $GUI_CHECKED : $GUI_UNCHECKED)
			_GUICtrlComboBox_SetCurSel($g_hCmbPriorityCCBaseFrequency, $g_iCmbPriorityCCBaseFrequency)
			_GUICtrlComboBox_SetCurSel($g_hcmbAdvancedVariationCC, $g_icmbAdvancedVariationCC)
			...
			GUICtrlSetState($hCGPlannerThenContinue, $bCGPlannerThenContinue ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($hCGPlannerThenStopBot, $bCGPlannerThenStopBot ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkSTOPWhenCGPointsMax, $g_bChkSTOPWhenCGPointsMax ? $GUI_CHECKED : $GUI_UNCHECKED)
		...
		Case "Save"
			...
			$g_bChkTreasuryCollect = _GUICtrlComboBox_GetCurSel($g_hChkTreasuryCollect)
			...
			$bUseClockPotion = (GUICtrlRead($g_hChkUseClockPotion) = $GUI_CHECKED) ? 1 : 0
			...
			$g_iCmbBuilderJar = _GUICtrlComboBox_GetCurSel($g_hCmbBuilderJar)
			...
			$g_bChkEnableSmartSwitchCC = (GUICtrlRead($g_hChkEnableSmartSwitchCC) = $GUI_CHECKED)
			$g_bChkEnablePurgeMedal = (GUICtrlRead($g_hChkEnablePurgeMedal) = $GUI_CHECKED)
			$g_iacmdMedalsExpected = GUICtrlRead($g_acmdMedalsExpected)
			$g_bChkEnablePriorArmyCC = (GUICtrlRead($g_hChkEnablePriorArmyCC) = $GUI_CHECKED)
			$g_bChkEnablePriorArmyCamp = (GUICtrlRead($g_hChkEnablePriorArmyCamp) = $GUI_CHECKED)
			$g_bChkEnablePriorBarracks = (GUICtrlRead($g_hChkEnablePriorBarracks) = $GUI_CHECKED)
			$g_bChkEnablePriorFactory = (GUICtrlRead($g_hChkEnablePriorFactory) = $GUI_CHECKED)
			$g_bChkEnablePriorStorage = (GUICtrlRead($g_hChkEnablePriorStorage) = $GUI_CHECKED)
			$g_bChkEnablePriorHallsCC = (GUICtrlRead($g_hChkEnablePriorHallsCC) = $GUI_CHECKED)
			$g_bChkEnablePriorHallsCC = (GUICtrlRead($g_hChkEnablePriorHallsCC) = $GUI_CHECKED)
			$g_bChkEnablePriorRuinsCC = (GUICtrlRead($g_hChkEnablePriorRuinsCC) = $GUI_CHECKED)
			$g_bChkEnableOnlyRuinsCC = (GUICtrlRead($g_hChkEnableOnlyRuinsCC) = $GUI_CHECKED)
			$g_bChkAutoUpgradeCCIgnore = (GUICtrlRead($g_hChkAutoUpgradeCCIgnore) = $GUI_CHECKED)
			$g_bChkEnablePriorPrioritized = (GUICtrlRead($g_hChkEnablePriorPrioritized) = $GUI_CHECKED)
			$g_bChkIsIgnoredWalls = (GUICtrlRead($g_hChkIsIgnoredWalls) = $GUI_CHECKED)
			$g_iCmbPriorityCCBaseFrequency = _GUICtrlComboBox_GetCurSel($g_hCmbPriorityCCBaseFrequency)
			$g_icmbAdvancedVariationCC = _GUICtrlComboBox_GetCurSel($g_hcmbAdvancedVariationCC)
...
Func ApplyConfig_600_11($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkUseOnlyCCMedals, $bChkUseOnlyCCMedals ? $GUI_CHECKED : $GUI_UNCHECKED)
			_GUICtrlComboBox_SetCurSel($g_ahCmbCCDecisionTime, $g_aiCmbCCDecisionTime)
			_GUICtrlComboBox_SetCurSel($g_ahCmbCCDecisionThen, $g_aiCmbCCDecisionThen)
			GUICtrlSetData($g_ahCmbCCMedalsSaveMin, $g_aiCmbCCMedalsSaveMin)
			; Request Type - Demen
...
Func ApplyConfig_600_13($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkDeleteOldFiles, $g_bChkDeleteOldFiles ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetData($g_hTxtDeleteOldFilesDays, $g_iaTxtDeleteOldFilesDays)
			ChkDeleteOldFiles()
		...
		Case "Save"
			...
			$g_bChkDeleteOldFiles = (GUICtrlRead($g_hChkDeleteOldFiles) = $GUI_CHECKED)
			$g_iaTxtDeleteOldFilesDays = Number(GUICtrlRead($g_hTxtDeleteOldFilesDays))
...
Func ApplyConfig_600_17($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkUpgradeWallAutoModEnabled, $g_bUpgradeWallAutoModEnabled ? $GUI_CHECKED : $GUI_UNCHECKED)
		...
		Case "Save"
			...
			$g_bUpgradeWallAutoModEnabled = (GUICtrlRead($g_hChkUpgradeWallAutoModEnabled) = $GUI_CHECKED)
...
Func ApplyConfig_600_18($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			chkPBTGenabled()
			GUICtrlSetState($g_hChkNotifyTGEnableInSecure, $g_bNotifyTGEnableInSecure ? $GUI_CHECKED : $GUI_UNCHECKED)
			...
			GUICtrlSetState($g_hChkCCRaidWarning, $g_bChkCCRaidWarning ? $GUI_CHECKED : $GUI_UNCHECKED)
			ChkVillageReport()
			chkUpgradeBattleMachine()
		Case "Save"
			; Telegram
			$g_bNotifyTGEnable = (GUICtrlRead($g_hChkNotifyTGEnable) = $GUI_CHECKED)
			$g_bNotifyTGEnableInSecure = (GUICtrlRead($g_hChkNotifyTGEnableInSecure) = $GUI_CHECKED)
			...
			$g_bChkCCRaidWarning = (GUICtrlRead($g_hChkCCRaidWarning) = $GUI_CHECKED)
	EndSwitch
...
Func ApplyConfig_600_28($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetData($g_hTxtRestartSearchlimitMin, $g_iSearchRestartLimitMin)
			GUICtrlSetData($g_hTxtRestartSearchlimitMax, $g_iSearchRestartLimitMax)
			GUICtrlSetData($g_hTxtRestartSearchlimitMinPause, $g_iSearchRestartLimitMinPause)
			GUICtrlSetData($g_hTxtRestartSearchlimitMaxPause, $g_iSearchRestartLimitMaxPause)
			GUICtrlSetData($g_hSearchesPauseIntervalMin, $g_iSearchesPauseIntervalMin)
			GUICtrlSetData($g_hSearchesPauseIntervalMax, $g_iSearchesPauseIntervalMax)
		...
		Case "Save"
			...
			$g_iSearchRestartLimitMin = GUICtrlRead($g_hTxtRestartSearchlimitMin)
			$g_iSearchRestartLimitMax = GUICtrlRead($g_hTxtRestartSearchlimitMax)
			$g_iSearchRestartLimitMinPause = GUICtrlRead($g_hTxtRestartSearchlimitMinPause)
			$g_iSearchRestartLimitMaxPause = GUICtrlRead($g_hTxtRestartSearchlimitMaxPause)
			$g_iSearchesPauseIntervalMin = GUICtrlRead($g_hSearchesPauseIntervalMin)
			$g_iSearchesPauseIntervalMax = GUICtrlRead($g_hSearchesPauseIntervalMax)
...
Func ApplyConfig_600_28_DB($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_ahChkMaxMultiArcher[$DB], $g_abFilterMaxMultiArcherEnable[$DB] ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_ahChkMaxRicochet[$DB], $g_abFilterMaxRicochetEnable[$DB] ? $GUI_CHECKED : $GUI_UNCHECKED)
			...
			_GUICtrlComboBox_SetCurSel($g_ahCmbWeakMultiArcher[$DB], $g_aiFilterMaxMultiArcherLevel[$DB])
			_GUICtrlComboBox_SetCurSel($g_ahCmbWeakRicochet[$DB], $g_aiFilterMaxRicochetLevel[$DB])
			chkDBWeakBase()
		...
		Case "Save"
			...
			$g_abFilterMaxMultiArcherEnable[$DB] = (GUICtrlRead($g_ahChkMaxMultiArcher[$DB]) = $GUI_CHECKED)
			$g_abFilterMaxRicochetEnable[$DB] = (GUICtrlRead($g_ahChkMaxRicochet[$DB]) = $GUI_CHECKED)
			...
			$g_aiFilterMaxMultiArcherLevel[$DB] = _GUICtrlComboBox_GetCurSel($g_ahCmbWeakMultiArcher[$DB])
			$g_aiFilterMaxRicochetLevel[$DB] = _GUICtrlComboBox_GetCurSel($g_ahCmbWeakRicochet[$DB])
...
Func ApplyConfig_600_28_LB($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_ahChkMaxMultiArcher[$LB], $g_abFilterMaxMultiArcherEnable[$LB] ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_ahChkMaxRicochet[$LB], $g_abFilterMaxRicochetEnable[$LB] ? $GUI_CHECKED : $GUI_UNCHECKED)
			...
			_GUICtrlComboBox_SetCurSel($g_ahCmbWeakMultiArcher[$LB], $g_aiFilterMaxMultiArcherLevel[$LB])
			_GUICtrlComboBox_SetCurSel($g_ahCmbWeakRicochet[$LB], $g_aiFilterMaxRicochetLevel[$LB])
			chkABWeakBase()
		...
		Case "Save"
			...
			$g_abFilterMaxMultiArcherEnable[$LB] = (GUICtrlRead($g_ahChkMaxMultiArcher[$LB]) = $GUI_CHECKED)
			$g_abFilterMaxRicochetEnable[$LB] = (GUICtrlRead($g_ahChkMaxRicochet[$LB]) = $GUI_CHECKED)
			...
			$g_aiFilterMaxMultiArcherLevel[$LB] = _GUICtrlComboBox_GetCurSel($g_ahCmbWeakMultiArcher[$LB])
			$g_aiFilterMaxRicochetLevel[$LB] = _GUICtrlComboBox_GetCurSel($g_ahCmbWeakRicochet[$LB])
...
Func ApplyConfig_600_32($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkTrophyAtkWithHeroesOnly, $g_bChkTrophyAtkWithHeroesOnly ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($hWaitOnlyOneHeroForDT, $bWaitOnlyOneHeroForDT ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($hWaitAllHeroesForDT, $bWaitAllHeroesForDT ? $GUI_CHECKED : $GUI_UNCHECKED)
			chkTrophyHeroes()
			ChkTrophyAtkWithHeroesOnly()
			_GUICtrlComboBox_SetCurSel($g_hCmbTrophyHeroesPriority, $g_iDropTrophyHeroesPriority)
			_GUICtrlComboBox_SetCurSel($g_hCmbTrophyHeroesPriority1, $g_iDropTrophyHeroesPriority1)
			_GUICtrlComboBox_SetCurSel($g_hCmbTrophyHeroesPriority2, $g_iDropTrophyHeroesPriority2)
			_GUICtrlComboBox_SetCurSel($g_hCmbTrophyHeroesPriority3, $g_iDropTrophyHeroesPriority3)
		...
		Case "Save"
			...
			$g_bChkTrophyAtkWithHeroesOnly = (GUICtrlRead($g_hChkTrophyAtkWithHeroesOnly) = $GUI_CHECKED)
			$bWaitOnlyOneHeroForDT = (GUICtrlRead($hWaitOnlyOneHeroForDT) = $GUI_CHECKED)
			$bWaitAllHeroesForDT = (GUICtrlRead($hWaitAllHeroesForDT) = $GUI_CHECKED)
			$g_iDropTrophyHeroesPriority = _GUICtrlComboBox_GetCurSel($g_hCmbTrophyHeroesPriority)
			$g_iDropTrophyHeroesPriority1 = _GUICtrlComboBox_GetCurSel($g_hCmbTrophyHeroesPriority1)
			$g_iDropTrophyHeroesPriority2 = _GUICtrlComboBox_GetCurSel($g_hCmbTrophyHeroesPriority2)
			$g_iDropTrophyHeroesPriority3 = _GUICtrlComboBox_GetCurSel($g_hCmbTrophyHeroesPriority3)
		...
		Case "Read"
			...
			If $g_bCustomDropOrderEnable Then ; only update troop train order if enabled
				...
				For $i = 0 To UBound($g_ahCmbDropOrder) - 1
					...
					EndIf
				Next
				If $iValueSet > 0 And $iValueSet < $eDropOrderCount Then
					SetLog("Set your Troops Drop Order For New Bot Version")
					BtnDropOrderSet()
				EndIf
		...
		Case "Read"
			...
			If $g_bCustomTrainOrderEnable Then ; only update troop train order if enabled
				...
				For $i = 0 To UBound($g_ahCmbTroopOrder) - 1
					...
					EndIf
				Next
				If $iValueSet > 0 And $iValueSet < $eTroopCount Then
					SetLog("Set your Troops Train Order For New Bot Version")
					BtnTroopOrderSet()
				EndIf
...
Func ApplyConfig_MOD_600_57($TypeReadSave)
	; <><><> CSV Speed <><><>
	Switch $TypeReadSave
		Case "Read"
	...
	EndSwitch
EndFunc   ;==>ApplyConfig_MOD_600_57
	...
	Switch $TypeReadSave
		Case "Read"
			...
			If $g_bCloseWhileTrainingEnable = True Then
				...
				For $i = $g_hLblSymbolWaiting To $g_hLblWaitingInMinutes
			...
			EndIf
			_GUICtrlComboBox_SetCurSel($g_hCmbCloseWaitRdmPercentMin, $g_iCloseRandomTimePercentMin)
			_GUICtrlComboBox_SetCurSel($g_hCmbCloseWaitRdmPercentMax, $g_iCloseRandomTimePercentMax)
			GUICtrlSetState($g_hdRadio_RandomClassic, $g_idRadio_RandomClassic ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hdRadio_RandomMod, $g_idRadio_RandomMod ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetData($g_hRandomCloseOptionPercent, $g_iRandomCloseOptionPercent)
		...
		Case "Save"
			...
			$g_iCloseRandomTimePercentMin = _GUICtrlComboBox_GetCurSel($g_hCmbCloseWaitRdmPercentMin)
			$g_iCloseRandomTimePercentMax = _GUICtrlComboBox_GetCurSel($g_hCmbCloseWaitRdmPercentMax)
			$g_idRadio_RandomClassic = (GUICtrlRead($g_hdRadio_RandomClassic) = $GUI_CHECKED)
			$g_idRadio_RandomMod = (GUICtrlRead($g_hdRadio_RandomMod) = $GUI_CHECKED)
			$g_iRandomCloseOptionPercent = Int(GUICtrlRead($g_hRandomCloseOptionPercent))
...
Func ApplyConfig_MOD_Humanization($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkUseSnacks, $g_bChkUseSnacks ? $GUI_CHECKED : $GUI_UNCHECKED)
		...
		Case "Save"
			...
			$g_bChkUseSnacks = (GUICtrlRead($g_hChkUseSnacks) = $GUI_CHECKED)
	EndSwitch
