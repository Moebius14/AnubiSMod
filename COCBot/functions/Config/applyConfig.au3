...
Func ApplyConfig_600_32($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkHeroesPriorityRandom, $g_iChkHeroesPriorityRandom ? $GUI_CHECKED : $GUI_UNCHECKED)
			chkTrophyHeroes()
		...
		Case "Save"
			...
			$g_iChkHeroesPriorityRandom = (GUICtrlRead($g_hChkHeroesPriorityRandom) = $GUI_CHECKED)
