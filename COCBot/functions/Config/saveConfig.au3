...
Func SaveConfig_Debug()
	...
	_Ini_Add("debug", "debugimagesaveMod", $g_bDebugImageSaveMod ? 1 : 0)
...
Func SaveConfig_600_6()
	...
	_Ini_Add("general", "CCTreasuryFull", $g_bCCTreasuryFull ? 1 : 0)
	...
	_Ini_Add("other", "ChkTreasuryCollect", $g_bChkTreasuryCollect)
	...
	_Ini_Add("other", "chkUseClockPotion", $bUseClockPotion)
	...
	_Ini_Add("other", "ChkBBAttackForDailyChallenge", $g_bChkBBAttackForDailyChallenge)
	_Ini_Add("other", "ChkUseBuilderJar", $g_bChkUseBuilderJar)
	_Ini_Add("other", "BuilderJarToUse", $g_iCmbBuilderJar)
	...
	_Ini_Add("ClanCapital", "EnablePurgeMedal", $g_bChkEnablePurgeMedal)
	_Ini_Add("ClanCapital", "cmdMedalsExpected", $g_iacmdMedalsExpected)
	_Ini_Add("ClanCapital", "ChkEnablePriorArmyCC", $g_bChkEnablePriorArmyCC)
	_Ini_Add("ClanCapital", "ChkEnablePriorArmyCamp", $g_bChkEnablePriorArmyCamp)
	_Ini_Add("ClanCapital", "ChkEnablePriorBarracks", $g_bChkEnablePriorBarracks)
	_Ini_Add("ClanCapital", "ChkEnablePriorFactory", $g_bChkEnablePriorFactory)
	_Ini_Add("ClanCapital", "ChkEnablePriorStorage", $g_bChkEnablePriorStorage)
	_Ini_Add("ClanCapital", "ChkEnablePriorHallsCC", $g_bChkEnablePriorHallsCC)
	_Ini_Add("ClanCapital", "ChkEnablePriorRuinsCC", $g_bChkEnablePriorRuinsCC)
	_Ini_Add("ClanCapital", "ChkEnableOnlyRuinsCC", $g_bChkEnableOnlyRuinsCC)
	_Ini_Add("ClanCapital", "ChkAutoUpgradeCCIgnore", $g_bChkAutoUpgradeCCIgnore)
	_Ini_Add("ClanCapital", "ChkEnablePriorPrioritized", $g_bChkEnablePriorPrioritized)
	_Ini_Add("ClanCapital", "ChkIsIgnoredWalls", $g_bChkIsIgnoredWalls)
	_Ini_Add("ClanCapital", "CCBaseFrequencyCheck", _GUICtrlComboBox_GetCurSel($g_hCmbPriorityCCBaseFrequency))
	_Ini_Add("ClanCapital", "CCBaseFrequencyCheckVariation", _GUICtrlComboBox_GetCurSel($g_hcmbAdvancedVariationCC))
...
Func SaveConfig_600_11()
	...
	_Ini_Add("donate", "ChkUseOnlyCCMedals", $bChkUseOnlyCCMedals ? 1 : 0)
	_Ini_Add("donate", "CCDecisionTime", _GUICtrlComboBox_GetCurSel($g_ahCmbCCDecisionTime))
	_Ini_Add("donate", "CCDecisionThen", _GUICtrlComboBox_GetCurSel($g_ahCmbCCDecisionThen))
	_Ini_Add("donate", "CCMedalsToSave", $g_aiCmbCCMedalsSaveMin)
	; Request Type - Demen
...
Func SaveConfig_600_13()
	...
	_Ini_Add("donate", "ChkDeleteOldFiles", $g_bChkDeleteOldFiles ? 1 : 0)
	_Ini_Add("donate", "TxtDeleteOldFilesDays", $g_iaTxtDeleteOldFilesDays)
...
Func SaveConfig_600_17()
	...
	_Ini_Add("upgrade", "auto-wallUP", $g_bUpgradeWallAutoModEnabled ? 1 : 0)
...
Func SaveConfig_600_28()
	...
	_Ini_Add("search", "reductionStorage", $g_bSearchReductionStorageEnable ? 1 : 0)
	_Ini_Add("search", "reduceGoldMod", $g_iSearchReductionGoldMod)
	_Ini_Add("search", "reduceElixirMod", $g_iSearchReductionElixirMod)
	_Ini_Add("search", "reduceDarkMod", $g_iSearchReductionDarkMod)
...
Func SaveConfig_600_56()
	...
	_Ini_Add("SmartZap", "UseSmartZapAD", _GUICtrlComboBox_GetCurSel($g_hChkSmartLightSpellAD))
	_Ini_Add("SmartZap", "ChkSweepersFirst", $g_bChkSweepersFirst ? 1 : 0)
EndFunc   ;==>SaveConfig_600_56

Func SaveConfig_MOD_600_57()
	; <><><> CSV Deploy Speed <><><>
	ApplyConfig_MOD_600_57(GetApplyConfigSaveAction())
	_Ini_Add("attack", "cmbCSVSpeedLB", $icmbCSVSpeed[$LB])
	_Ini_Add("attack", "cmbCSVSpeedDB", $icmbCSVSpeed[$DB])
EndFunc   ;==>SaveConfig_MOD_600_57
...
Func SaveConfig_641_1()
	...
	_Ini_Add("other", "CloseWaitRdmPercentMin", $g_iCloseRandomTimePercentMin)
	_Ini_Add("other", "CloseWaitRdmPercentMax", $g_iCloseRandomTimePercentMax)
...
Func SaveConfig_MOD_Humanization()
	...
	_Ini_Add("Bot Humanization", "IsChkWarSignUp", $g_bChkWarSignUp ? 1 : 0)
	...
	_Ini_Add("Bot Humanization", "IschkUseSnacks", $g_bChkUseSnacks ? 1 : 0)
EndFunc   ;==>SaveConfig_MOD_Humanization

Func SaveConfig_MOD_Advanced()
	; <><><> Advanced <><><>
	ApplyConfig_MOD_Advanced(GetApplyConfigSaveAction())
