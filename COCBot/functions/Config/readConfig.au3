...
Func ReadClanGamesConfig()
	...
	$g_bChkClanGamesEquipment = False
...
Func ReadConfig_600_6()
	...
	IniReadS($g_bCCTreasuryFull, $g_sProfileConfigPath, "general", "CCTreasuryFull", False, "Bool")
	...
	IniReadS($g_bChkTreasuryCollect, $g_sProfileConfigPath, "other", "ChkTreasuryCollect", 0, "int")
	...
	IniReadS($bUseClockPotion, $g_sProfileConfigPath, "other", "chkUseClockPotion", $bUseClockPotion, "Bool")
	...
	IniReadS($g_bChkBBAttackForDailyChallenge, $g_sProfileConfigPath, "other", "ChkBBAttackForDailyChallenge", False, "Bool")
	IniReadS($g_bChkUseBuilderJar, $g_sProfileConfigPath, "other", "ChkUseBuilderJar", False, "Bool")
	IniReadS($g_iCmbBuilderJar, $g_sProfileConfigPath, "other", "BuilderJarToUse", $g_iCmbBuilderJar, "int")
	...
	IniReadS($g_bChkEnableSmartSwitchCC, $g_sProfileConfigPath, "ClanCapital", "SmartSwitchCC", False, "Bool")
	IniReadS($g_bChkEnablePurgeMedal, $g_sProfileConfigPath, "ClanCapital", "EnablePurgeMedal", False, "Bool")
	IniReadS($g_iacmdMedalsExpected, $g_sProfileConfigPath, "ClanCapital", "cmdMedalsExpected", $g_iacmdMedalsExpected, "int")
	IniReadS($g_bChkEnablePriorArmyCC, $g_sProfileConfigPath, "ClanCapital", "ChkEnablePriorArmyCC", False, "Bool")
	IniReadS($g_bChkEnablePriorArmyCamp, $g_sProfileConfigPath, "ClanCapital", "ChkEnablePriorArmyCamp", False, "Bool")
	IniReadS($g_bChkEnablePriorBarracks, $g_sProfileConfigPath, "ClanCapital", "ChkEnablePriorBarracks", False, "Bool")
	IniReadS($g_bChkEnablePriorFactory, $g_sProfileConfigPath, "ClanCapital", "ChkEnablePriorFactory", False, "Bool")
	IniReadS($g_bChkEnablePriorStorage, $g_sProfileConfigPath, "ClanCapital", "ChkEnablePriorStorage", False, "Bool")
	IniReadS($g_bChkEnablePriorHallsCC, $g_sProfileConfigPath, "ClanCapital", "ChkEnablePriorHallsCC", False, "Bool")
	IniReadS($g_bChkEnablePriorRuinsCC, $g_sProfileConfigPath, "ClanCapital", "ChkEnablePriorRuinsCC", False, "Bool")
	IniReadS($g_bChkEnableOnlyRuinsCC, $g_sProfileConfigPath, "ClanCapital", "ChkEnableOnlyRuinsCC", False, "Bool")
	IniReadS($g_bChkAutoUpgradeCCIgnore, $g_sProfileConfigPath, "ClanCapital", "ChkAutoUpgradeCCIgnore", False, "Bool")
	IniReadS($g_bChkEnablePriorPrioritized, $g_sProfileConfigPath, "ClanCapital", "ChkEnablePriorPrioritized", False, "Bool")
	IniReadS($g_bChkIsIgnoredWalls, $g_sProfileConfigPath, "ClanCapital", "ChkIsIgnoredWalls", False, "Bool")
	IniReadS($g_iCmbPriorityCCBaseFrequency, $g_sProfileConfigPath, "ClanCapital", "CCBaseFrequencyCheck", $g_iCmbPriorityCCBaseFrequency, "int")
	IniReadS($g_icmbAdvancedVariationCC, $g_sProfileConfigPath, "ClanCapital", "CCBaseFrequencyCheckVariation", $g_icmbAdvancedVariationCC, "int")
...
Func ReadConfig_600_11()
	...
	IniReadS($bChkUseOnlyCCMedals, $g_sProfileConfigPath, "donate", "ChkUseOnlyCCMedals", $bChkUseOnlyCCMedals, "Bool")
	IniReadS($g_aiCmbCCDecisionTime, $g_sProfileConfigPath, "donate", "CCDecisionTime", $g_aiCmbCCDecisionTime, "int")
	IniReadS($g_aiCmbCCDecisionThen, $g_sProfileConfigPath, "donate", "CCDecisionThen", $g_aiCmbCCDecisionThen, "int")
	IniReadS($g_aiCmbCCMedalsSaveMin, $g_sProfileConfigPath, "donate", "CCMedalsToSave", $g_aiCmbCCMedalsSaveMin, "Int")
	; Request Type - Demen
	...
	For $i = 0 To 2
		...
		If $g_aiClanCastleSiegeWaitType[$i] > 0 Then $g_aiCCSiegeExpected[$g_aiClanCastleSiegeWaitType[$i] - 1] = 1 ; WallW - BattleD
	Next
...
Func ReadConfig_600_12()
	...
	$g_sTxtGeneralBlacklist = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtBlacklist", $g_sTxtGeneralBlacklist), "|", @CRLF)
...
Func ReadConfig_600_13()
	...
	IniReadS($g_bChkDeleteOldFiles, $g_sProfileConfigPath, "donate", "ChkDeleteOldFiles", False, "Bool")
	IniReadS($g_iaTxtDeleteOldFilesDays, $g_sProfileConfigPath, "donate", "TxtDeleteOldFilesDays", 5, "int")
...
Func ReadConfig_600_28()
	...
	IniReadS($g_bSearchReductionStorageEnable, $g_sProfileConfigPath, "search", "reductionStorage", False, "Bool")
	IniReadS($g_iSearchReductionGoldMod, $g_sProfileConfigPath, "search", "reduceGoldMod", 2000, "int")
	IniReadS($g_iSearchReductionElixirMod, $g_sProfileConfigPath, "search", "reduceElixirMod", 2000, "int")
	IniReadS($g_iSearchReductionDarkMod, $g_sProfileConfigPath, "search", "reduceDarkMod", 100, "int")
	IniReadS($g_iSearchDelayMin, $g_sProfileConfigPath, "other", "VSDelay", 1, "Int")
	IniReadS($g_iSearchDelayMax, $g_sProfileConfigPath, "other", "MaxVSDelay", 5, "Int")
	...
	IniReadS($g_iSearchesPauseIntervalMin, $g_sProfileConfigPath, "search", "RestartSearchLimitMinPauseTime", 3, "int")
	IniReadS($g_iSearchesPauseIntervalMax, $g_sProfileConfigPath, "search", "RestartSearchLimitMaxPauseTime", 7, "int")
...
Func ReadConfig_600_29()
	...
	$g_iAttackPlannerRandomTime = Int(IniRead($g_sProfileConfigPath, "planned", "cmbAttackPlannerRandom", 2))
...
Func ReadConfig_600_35_1()
	...
	IniReadS($g_iDeleteLogsDays, $g_sProfileConfigPath, "deletefiles", "DeleteLogsDays", 1, "int")
	IniReadS($g_bDeleteTemp, $g_sProfileConfigPath, "deletefiles", "DeleteTemp", True, "Bool")
	IniReadS($g_iDeleteTempDays, $g_sProfileConfigPath, "deletefiles", "DeleteTempDays", 1, "int")
	IniReadS($g_bDeleteLoots, $g_sProfileConfigPath, "deletefiles", "DeleteLoots", True, "Bool")
	IniReadS($g_iDeleteLootsDays, $g_sProfileConfigPath, "deletefiles", "DeleteLootsDays", 1, "int")
...
Func ReadConfig_641_1()
	...
	IniReadS($g_bCloseRandom, $g_sProfileConfigPath, "other", "btnCloseWaitStopRandom", True, "Bool")
	...
	IniReadS($g_iCloseRandomTimePercentMin, $g_sProfileConfigPath, "other", "CloseWaitRdmPercentMin", $g_iCloseRandomTimePercentMin, "int")
	IniReadS($g_iCloseRandomTimePercentMax, $g_sProfileConfigPath, "other", "CloseWaitRdmPercentMax", $g_iCloseRandomTimePercentMax, "int")
	...
	IniReadS($g_iTrainClickDelay, $g_sProfileConfigPath, "other", "TrainITDelay", $g_iTrainClickDelay, "int")
...
Func ReadConfig_MOD_Humanization()
	...
	IniReadS($g_bChkUseSnacks, $g_sProfileConfigPath, "Bot Humanization", "IschkUseSnacks", $g_bChkUseSnacks, "Bool")
