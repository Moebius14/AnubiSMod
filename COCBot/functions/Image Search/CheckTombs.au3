	...
	If IsArray($aiButton) And UBound($aiButton) >= 2 Then
		...
		If $g_iFreeBuilderCount = 1 Then
			...
			While $IsCleaningRunning
				...
				Local $CancelButton = _MultiPixelSearch(335, 572, 475, 605, 1, 1, Hex(0x0D0D0D, 6), $offColors, 40) ; first black pixel on side of button
				...
				SetDebugLog("Pixel Color #1: " & _GetPixelColor(343, 572, True) & ", #2: " & _GetPixelColor(377, 593, True) & ", #3: " & _GetPixelColor(381, 601, True) & ", #4: " & _GetPixelColor(424, 572, True), $COLOR_DEBUG)
